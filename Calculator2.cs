...
namespace Calculator
{
    public partial class Calculator2 : Form
    {
        ...
        public Calculator2() //starts calculator
        {
            InitializeComponent();
        }
        ...
        private void oneButton_Click(object sender, EventArgs e)//makes the one button function and pressable
        {
        ...
        private void EqualButton_Click_1(object sender, EventArgs e)//makes the equal button function and pressable
        {
            double Result;
            try
            {
        ...
        private void MultiplyButton_Click_1(object sender, EventArgs e)//makes the times button function and pressable
        {
            try
            {
        ...
        private void DivideButton_Click_1(object sender, EventArgs e)//makes the divide button function and pressable
        {
            try
            {
                FirstNumber = Convert.ToDouble(MainDisplay.Text);
        ...
        private void PlusButton_Click_1(object sender, EventArgs e)//makes the plus button function and pressable
        {
            try
            {
                FirstNumber = Convert.ToDouble(MainDisplay.Text);
        ...
        private void MinusButton_Click_1(object sender, EventArgs e)//makes the minus button function and pressable
        {
            try
            {
        ...
        private void percentageButton_Click_1(object sender, EventArgs e)//makes the percentage button function and pressable
        {
            try
            {
        ...
        private void decimalbutton_Click_1(object sender, EventArgs e)//makes the decimal button function and pressable
        {
            if (MainDisplay.Text == "" && MainDisplay.Text != null)
            {
                MainDisplay.Text = ".";
        ...
        private void pibutton_Click_1(object sender, EventArgs e)//makes the pi button function and pressable
        {
            if (MainDisplay.Text == "" && MainDisplay.Text != null)
            {
        ...
        private void AllClear_Click_1(object sender, EventArgs e)//clears all the displays
        {
            MainDisplay.Clear();
            SecondDisplay.Clear();
            EqualButton.Enabled = true;
        ...
        private void VisualButton_Click_1(object sender, EventArgs e)
        {
            this.Hide();
